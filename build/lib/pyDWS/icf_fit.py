...
def icf_fit(filePath, name, alphaRange=np.arange(0, 22.5, 1.5), plateauVal=False, max_iterations=400, iteration_step = 10000, PathPguess= None, icfFitPath=None):
    """

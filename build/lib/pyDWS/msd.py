...
# MSD calculation 
def msd(t, g2, lstar, lambda_laser, L, n, radi, range_icf, msdPath=None):
    """
    ...
    -------
    MSD : numpy array
        2d array. First column time array. Second column calculated mean squared displacement MSD. 
    gcal : numpy array
    ...
    for i in range(idx, -1, -1):
        ...
        if gi >= 1 or gi <= 0:
            ...
            result = minimize_scalar(fun, bounds=(1e-4, 1e3), method='bounded', options={'xatol': 1e-16})
